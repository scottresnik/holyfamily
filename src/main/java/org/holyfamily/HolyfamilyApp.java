package org.holyfamily;

import org.holyfamily.config.ApplicationProperties;
import org.holyfamily.config.DefaultProfileUtil;
...
public class HolyfamilyApp {

    private static final Logger log = LoggerFactory.getLogger(HolyfamilyApp.class);

    private final Environment env;

    public HolyfamilyApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes holyfamily.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HolyfamilyApp.class);
